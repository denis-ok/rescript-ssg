...
[@mel.module "node:worker_threads"] external parentPort: parentPort = "parentPort";

module Worker = {
  type workerDataArg('a) = {workerData: 'a};

  [@mel.new] [@mel.module "node:worker_threads"] external make: (string, workerDataArg('a)) => worker = "Worker";
